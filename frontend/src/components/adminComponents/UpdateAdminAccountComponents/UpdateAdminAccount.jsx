...
import UpdateAdminAccountForm from "./UpdateAdminAccountForm";
        ...
        <div className="max-w-7xl mx-auto">
          {!isMobile && (
            <>
              ...
              <p className="text-gray-600 mt-1">Update admin account details</p>
            </>
          )}
