...
export default function AdminCreateAccountSideBar() {
  return (
    <nav className="bg-gradient-to-b from-yellow-500 via-yellow-400 to-yellow-300 h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] tracking-wide shadow-lg shadow-gray-500/50 overflow-hidden">
